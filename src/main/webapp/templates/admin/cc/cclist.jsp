					...
					<div class="admin_content">
						...
						<div class="card" style="clear: both">
							<div class="card-body p-0">
								<table class="table table-bordered" style="margin-bottom: 0px;">
									<thead style="background-color: #797574 !important;">
										<tr>
											<th scope="col">CC Num</th>
											<th scope="col">Proprietaire</th>
											<th scope="col" style="width: 18%; text-align: center">Action</th>
										</tr>
									</thead>
									<tbody>
										<s:iterator value="cartecredits">
											<tr>
												<td><s:property value="numCarte" /></td>
												<td><s:property value="	proprietaire.getNom()" /></td>

												<td>
												<s:url namespace="/" action="show_cc" var="lien1">
														<s:param name="ccid">
							...
							<a type="button" class="btn btn-primary"
								...
								href="${pageContext.request.contextPath}/add_cc">Ajouter</a>
						</div>
