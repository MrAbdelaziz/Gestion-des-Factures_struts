	...
	<div class="container mt-2">
		<div class="row">
			...
			<div class="col-lg-9 p-0" style="width: 100%">
				<div class="container">
					<div class="admin_content" style="color: white;">
						<a href="${pageContext.request.contextPath}/cclist"
							class="btn btn-outline-info">Back </a>
						<s:form action="savecc" method="post" class="mb-5">

							<div class="card" style="width: 100%; border: 0px">		
								 <s:textfield name="cartecredit.numCarte"  labelposition="top" label="numCarte"></s:textfield>
        ...
        <s:select name="proprietaire.id" label="Proprietaire" labelposition="top" value="1" list="proprietaires" listKey="id" listValue="nom" />
					...
					<s:if test="%{ccid != null}">
					<s:hidden><s:hidden name="ccid"></s:hidden></s:hidden>
					</s:if>
					</s:form>
						<s:if test="%{ccid != null}">
									<s:url namespace="/" action="delete_cc" var="lien1">
										<s:param name="ccid">
											<s:property value="ccid" />
										</s:param>
									</s:url>
									<s:a href="%{lien1}" cssClass="btn btn-danger">Delete</s:a>
